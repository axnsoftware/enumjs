...
Enum.create = function(decl) {
	...
	return (function() {
		...
		/**
		 *
		 * @return the ordinal assigned to this.
		 */
		clazz.prototype.valueOf = function() {
		...
		for (var key in decl) {
			...
			if (typeof spec == 'number') {
				...
				if ('ordinal' in spec && typeof spec.ordinal == 'number') {
					newOrd = spec.ordinal;
				} // if no ordinal is specified, continue with sequence
			} else {
